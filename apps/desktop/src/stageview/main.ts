...
!(function(exports) {
    ...
    function updatePresentation() {
        ...
        if (o) {
            if (p_text_orientation_local == "2") {
                ...
                _$.p_text2_arr = _$.p_text1_arr;
                _$.p_text2_font = _$.p_text1_font;
            } else {
                p_text_orientation_local = "1";
            }
        }
        ...
        switch (p_text_orientation_local) {
            ...
            default:
                ...
                header_height = parseInt(_$.p_window_Y * 0.1);
                content1_top = header_top + header_height + 1;
                content1_left = header_left;
                content1_width = _$.p_window_X;
                content1_height = parseInt(_$.p_window_Y * g);
            ...
            case "1":
                ...
                content1_top = header_top + header_height + 1;
                content1_left = header_left;
                content1_width = parseInt(_$.p_window_X * 0.5);
                content1_height = parseInt(_$.p_window_Y * 0.8);
                ...
                if (o) {
                    ...
                    footerL_width = parseInt(_$.p_window_X * 0.5);
                    footerL_height = parseInt(_$.p_window_Y * 0.1);
            ...
            case "2":
                if (o) {
                    ...
                    header_left = 0;
                    header_width = _$.p_window_X;
                    header_height = parseInt(_$.p_window_Y * 0.05);
                    content1_top = header_top + header_height + 1;
                    content1_left = header_left;
                    content1_width = _$.p_window_X;
                    content1_height = parseInt(_$.p_window_Y * 0.85);
                    content2_top = content1_top + content1_height + 1;
                    content2_left = header_left;
                    content2_width = _$.p_window_X;
                    content2_height = 0;
            ...
            case "3":
                ...
                header_width = _$.p_window_X;
                header_height = 0;
                content1_top = parseInt(_$.p_window_Y * m);
                content1_left = 0;
                content1_width = parseInt(_$.p_window_X * 0.5);
                content1_height = parseInt(_$.p_window_Y * F);
                content2_top = parseInt(_$.p_window_Y * m) + 5;
                ...
                if (c) {
                    ...
                    if (q) {
                        ...
                        content2_width = parseInt(_$.p_window_X);
            ...
            case "4":
                ...
                content1_left = header_left;
                content1_width = _$.p_window_X;
                content1_height = parseInt(_$.p_window_Y * 0.45);
                content2_top = content1_top + content1_height + 1;
                content2_left = header_left;
                content2_width = _$.p_window_X;
                content2_height = parseInt(_$.p_window_Y * 0.45);
                footer_top = 0;
                footer_left = 0;
                footer_width = _$.p_window_X;
                footer_height = 0;
        ...
        $("#content1").css("font-family", _$.p_text1_font);
        $("#content1").css("color", _$.p_font_color);
        ...
        $("#content2").css("font-family", _$.p_text2_font);
        ...
        if (!c) {
            if (_$.p_text2_arr[_$.p_current_index] != null) {
                var j = _$.p_text2_arr[_$.p_current_index].length;
                if (j > 1) {
                    while (
    ...
    function init() {
        ...
        // June 28, 2020 - Show black screen for 250ms before switching to green to avoid green screen flash
        $("#backgroundLayer").css("background-color", "#01541f");
        setTimeout(initStageView, 250);
    }

    // exports (global)
    exports.$init = init; // body onload
