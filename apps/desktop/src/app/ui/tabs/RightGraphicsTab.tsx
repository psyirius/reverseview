        ...
        <div id="graphicsTab">
            <div id="graphicsDiv">
                <div id="leftcolumn">
                    ...
                    <img id="selected_still_id" width={150} height={100} alt=""/><br/>
                    {/* <input type="button" id="setAsBackgroundButtonID" value=" SET as Background "> */}
                    <br/><br/>

                    <div class="generalheading2">Logo Image</div>

                    <img id="selected_logostill_id" width={150} height={100} alt=""/><br/>
                ...
                <div id="rightcolumn">
                    ...
                    <div class="style2">
                        ...
                        <input type="radio" name="bkgndtype" id="bkgnd_gradient" value="1"/> Gradient
                    ...
                    <div id="still_bkgnddiv" class="still_bkgnddiv_style style2">
                        <div id="list_still_bkgnd_div" class="list_still_bkgnd_style">
                            ...
                            <div class="floatleftClass"><img id="selectedx_still_id" width="150" height="100" alt=""/></div>
