!(function (exports) {
    ...
    function saveVersionSelection() {
        ...
        if (b != f) {
            ...
            rvw.bible.loadSQLBible(b, 1);
        }
        if (g != e) {
            $RvW.bibledbObj[2].closeDB();
            $RvW.bibledbObj[2] = null;
            rvw.bible.loadSQLBible(g, 2);
        }
        if (b != f) {
            ...
            $RvW.searchObj = new rvw.bible.BibleSearch(a);
    ...
    // Exports
    exports.loadBibleVersion = loadBibleVersion;
    exports.versionFill = versionFill;
    exports.loadVersion = loadVersion;
    exports.showBrowse = showBrowse;
    exports.manageVersion = manageVersion;
    exports.processSingleVersion = processSingleVersion;
    exports.getVersion1Filename = getVersion1Filename;
    exports.getVersion1Font = getVersion1Font;
    exports.getVersion1Name = getVersion1Name;
    exports.updateVersionXML = updateVersionXML;
