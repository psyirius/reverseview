class chordsDatabaseClass {
  constructor() {
    ...
    function q() {
      ...
      l.sqlConnection = r;
      var T = "CREATE TABLE IF NOT EXISTS cm (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, lyrics TEXT, chords TEXT, key TEXT, chordsby TEXT, timestamp TEXT, bpm INTEGER, notes TEXT, timesignature TEXT, rhythm TEXT, complexity TEXT, tags TEXT, rating INTEGER, original BOOLEAN, usagecount INTEGER, category TEXT, additional TEXT )";
      l.text = T;
    ...
    function o() {
      ...
      function T(X) {
        ...
        var Y = "Loading chords record for export error:" +
          X.error +
          " | " +
          X.error.code +
          " | " +
    ...
    function f() {
      ...
      function T(X) {
        ...
        var Y = "Loading chords record error:" +
          X.error +
          " | " +
          X.error.code +
          " | " +
