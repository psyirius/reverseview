function notes() {
  ...
  function K() {
    ...
    S.sqlConnection = g;
    var R =
      "CREATE TABLE IF NOT EXISTS notesInfoTable (noteInfoName TEXT, noteInfoDes TEXT)";
    S.text = R;
    S.addEventListener(air.SQLEvent.RESULT, Q);
    S.addEventListener(air.SQLErrorEvent.ERROR, P);
    S.execute();
  ...
  function h() {
    ...
    S.sqlConnection = g;
    var R =
      "INSERT INTO notesInfoTable (noteInfoName, noteInfoDes) VALUES (:infoName, :infoDes);";
    S.text = R;
    S.addEventListener(air.SQLEvent.RESULT, Q);
    S.addEventListener(air.SQLErrorEvent.ERROR, P);
  ...
  function u(S, Q) {
    ...
    U.sqlConnection = g;
    var T =
      "UPDATE notesTable SET noteText = :noteText, noteTextFormat = :noteTextFormat WHERE bookNum = :b AND chNum = :c AND verseNum = :v;";
    U.text = T;
