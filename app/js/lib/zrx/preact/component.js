define(["require", "exports", "./util", "./diff/index", "./options", "./create-element"], function (require, exports, util_1, index_1, options_1, create_element_1) {
    "use strict";
    ...
    function renderComponent(component) {
        ...
        if (parentDom) {
            ...
            (0, index_1.diff)(parentDom, vnode, oldVNode, component._globalContext, parentDom.ownerSVGElement !== undefined, vnode._hydrating != null ? [oldDom] : null, commitQueue, oldDom == null ? getDomSibling(vnode) : oldDom, vnode._hydrating, refQueue);
