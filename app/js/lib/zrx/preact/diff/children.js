define(["require", "exports", "./index", "../create-element", "../constants", "../util", "../component"], function (require, exports, index_1, create_element_1, constants_1, util_1, component_1) {
    "use strict";
    ...
    function diffChildren(parentDom, renderResult, newParentVNode, oldParentVNode, globalContext, isSvg, excessDomChildren, commitQueue, oldDom, isHydrating, refQueue) {
        var i, j, oldVNode, childVNode, newDom, firstChildDom, skew = 0;
        // This is a compression of oldParentVNode!=null && oldParentVNode != EMPTY_OBJ && oldParentVNode._children || EMPTY_ARR
        // as EMPTY_OBJ._children should be `undefined`.
        var oldChildren = (oldParentVNode && oldParentVNode._children) || constants_1.EMPTY_ARR;
        var oldChildrenLength = oldChildren.length, remainingOldChildren = oldChildrenLength, newChildrenLength = renderResult.length;
        ...
        for (i = 0; i < newChildrenLength; i++) {
            ...
            if (matchingIndex === -1) {
                ...
                oldVNode = oldChildren[matchingIndex] || constants_1.EMPTY_OBJ;
                oldChildren[matchingIndex] = undefined;
                remainingOldChildren--;
            }
            // Morph the old element into the new one, but don't append it to the dom yet
            (0, index_1.diff)(parentDom, childVNode, oldVNode, globalContext, isSvg, excessDomChildren, commitQueue, oldDom, isHydrating, refQueue);
            ...
            if (newDom != null) {
                ...
                var isMounting = oldVNode === constants_1.EMPTY_OBJ || oldVNode._original === null;
                if (isMounting) {
                    if (matchingIndex == -1) {
                        skew--;
                    }
