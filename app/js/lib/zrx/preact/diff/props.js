define(["require", "exports", "../constants", "../options"], function (require, exports, constants_1, options_1) {
    "use strict";
    ...
    function eventProxy(e) {
        var eventHandler = this._listeners[e.type + false];
        /**
        ...
        return eventHandler(options_1["default"].event ? options_1["default"].event(e) : e);
    }
    function eventProxyCapture(e) {
        return this._listeners[e.type + true](options_1["default"].event ? options_1["default"].event(e) : e);
    }
});
